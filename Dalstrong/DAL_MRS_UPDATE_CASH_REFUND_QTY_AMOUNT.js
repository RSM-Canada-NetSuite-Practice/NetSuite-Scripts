          ...
          for (var i = 0; i < cashsalelinecount; i++) {
            ...
            for (var k = 0; k < cashrefundlinecount; k++) {
              ...
              cash_refund.setCurrentSublistValue({
                sublistId: 'item',
                fieldId: 'item',
                value: cashsaletran[i].sku
              });
              cash_refund.setCurrentSublistValue({
                sublistId: 'item',
                fieldId: 'quantity',
                value: cashsaletran[i].qty
              });
              cash_refund.setCurrentSublistValue({
                sublistId: 'item',
                fieldId: 'custcol_celigo_etail_order_line_id',
                value: cashsaletran[i].orderid
              });
              cash_refund.setCurrentSublistValue({
                sublistId: 'item',
                fieldId: 'amount',
                value: cashsaletran[i].amount
              });
              cash_refund.setCurrentSublistValue({
                sublistId: 'item',
                fieldId: 'taxcode',
            ...
            var newcashrefundamount = cash_refund.getValue({fieldId:'amount'});
